...
///
/// Thread-safe via `OSAllocatedUnfairLock`. Observes `local.mural.wallpapers.prefsChanged`
...
final class WallpaperPrefs: @unchecked Sendable {
    ...
    private static var prefsURL: URL {
        docsURL.appendingPathComponent("mural-prefs.json")
    }

    private static var stateURL: URL {
        docsURL.appendingPathComponent("mural-state.json")
    }
    ...
    func observeChanges() {
        ...
        CFNotificationCenterAddObserver(
            ...
            "local.mural.wallpapers.prefsChanged" as CFString,
            nil,
            .deliverImmediately,
        )
    }
    ...
    private func postStateNotification() {
        ...
        CFNotificationCenterPostNotification(
            center,
            CFNotificationName("local.mural.wallpapers.stateChanged" as CFString),
            nil,
            nil,
            true,
        )
